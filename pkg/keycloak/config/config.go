...
type Config struct {
	...
	Resources                          []*core.Resource  `json:"resources,omitempty" usage:"list of resources 'uri=/admin*|methods=GET,PUT|roles=role1,role2'" yaml:"resources"`
...
func (r *Config) SetResources(resources []*core.Resource) {
	r.Resources = resources
}

func (r *Config) GetResources() []*core.Resource {
	return r.Resources
}
